...
export default {
  ...
  safelist: [
    ...
    // Hover, Focus, Disabled, and Background states
    {
      pattern: /(hover|focus|disabled):(text|bg|border)-primary-(50|100|200|300|400|500|600|700)/,
    },
    {
      pattern: /bg-primary-(50|100|200|300|400|500|600|700)/,
    },
  ],
  theme: {
    extend: {
      colors: {
        transparent: "transparent",
        primary: {
          50: "#FFFDE7", // Lightest Yellow for background
          100: "#FFF9C4", // Very Light Yellow for hover state
          200: "#FFF59D", // Light Yellow for focus state
          300: "#FFE066", // Light Yellow
          400: "#FFD233", // Medium Yellow for disabled text
          500: "#FFD700", // Default Yellow
          600: "#FFC300", // Focus Yellow
          700: "#FFB000", // Hover Yellow
        },
        neutral: {
          50: "#f8fafc",
          100: "#f1f5f9",
