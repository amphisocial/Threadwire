/**
 * =============================================================================
 * Tabs.jsx - Dashboard Navigation Component with Filters
 * =============================================================================
 * Same tabular navigation as NavBar.jsx but includes filter controls below.
 * Uses "tw-nav" class names to avoid CSS conflicts with global styles.css.
 * 
 * Used exclusively on the Dashboard/LandingPage which has card-grid filters.
 * 
...
const Tabs = ({ filters, onFilterChange }) => {
  ...
  const handleNavigation = (tab) => {
    switch (tab) {
      ...
      default: console.error(`Unknown tab: ${tab}`);
    }
  };
